...
?>
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>РђСЂРєР°РЅРѕРёРґ вЂ” DonateCraft</title><link rel="stylesheet" href="style.css"><style>
...
<div class="game-info-item"><span class="lbl">Р–РёР·РЅРё</span><span class="val" id="livesDisplay">вќ¤пёЏвќ¤пёЏвќ¤пёЏ</span></div>
</div>
...
function updateLives() {
    livesDisplay.textContent = 'вќ¤пёЏ'.repeat(lives);
}
...
function draw() {
    ...
    if (gameOver) {
        ...
        ctx.fillText('РРіСЂР° РѕРєРѕРЅС‡РµРЅР°!', canvas.width / 2, canvas.height / 2 - 10);
        ctx.fillStyle = '#ffaa33';
        ctx.font = '18px Inter, sans-serif';
        ctx.fillText('РЎС‡С‘С‚: ' + score, canvas.width / 2, canvas.height / 2 + 25);
    } else if (!running) {
        ctx.fillStyle = '#ffaa33';
        ctx.font = '18px Inter, sans-serif';
        ctx.textAlign = 'center';
        ctx.fillText('РќР°Р¶РјРё "РќРѕРІР°СЏ РёРіСЂР°"', canvas.width / 2, canvas.height / 2);
    }
}
