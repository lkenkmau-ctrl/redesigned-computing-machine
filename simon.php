...
<div class="game-info-bar"><div class="game-info-item"><span class="lbl">Раунд</span><span class="val" id="roundDisplay">0</span></div><div class="game-info-item"><span class="lbl">Счёт</span><span class="val" id="scoreDisplay">0</span></div><div class="game-info-item"><span class="lbl">Рекорд</span><span class="val" id="bestDisplay"><?= $bestScore ?></span></div></div>
<div class="game-area">
...
function nextRound() {
    ...
    gameMessage.textContent = 'Раунд ' + round + ' — запомните последовательность!';
    playSequence(() => {
        gameMessage.textContent = 'Ваш ход — повторите!';
    });
}
...
function endGame() {
    ...
    gameMessage.textContent = '😵 Неправильно! Вы продержались ' + round + ' раундов. Счёт: ' + finalScore;
