...
if (!isset($_SESSION['admin']) && (!isset($_POST['apass']) || $_POST['apass'] !== $password)) {
    ...
    echo '<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>�������</title><link rel="stylesheet" href="style.css"></head><body><header><div class="header-inner"><a href="index.php" class="logo-link">'.$site_name.'</a></div></header><div class="container"><div class="form-card animate-in"><h1>?? ���� � �������</h1>';
    if (isset($err)) echo '<div class="msg msg-error">'.$err.'</div>';
    echo '<form method="post"><input type="password" name="apass" placeholder="������ ��������������" required><button type="submit" class="btn">�����</button></form></div></div></body></html>';
    exit;
}
$_SESSION['admin'] = true;
...
<header>
    <div class="header-inner">
        ...
        <nav class="nav">
            ...
            <a href="admin.php" class="btn btn-sm btn-red">?? �����</a>
        </nav>
    </div>
</header>
<div class="container animate-in">
    ...
    <div class="admin-stats">
        <div class="admin-stat gold"><span class="num"><?= $pending_count ?></span><span class="lbl">? ������� ������</span></div>
        <div class="admin-stat green"><span class="num"><?= $completed_donations ?></span><span class="lbl">? ������ �������</span></div>
        <div class="admin-stat blue"><span class="num"><?= $total_donations ?></span><span class="lbl">?? ����� �������</span></div>
        <div class="admin-stat"><span class="num" style="color:#00bfff;"><?= $total_users ?></span><span class="lbl">?? �������������</span></div>
    </div>

    <div class="card" style="border-color:rgba(255,170,0,0.4);">
        <h2 style="color:#ffaa00;">? ������� ������ (<?= $pending_count ?>)</h2>
        <?php if ($pending_count === 0): ?>
            <p style="text-align:center;color:#888;padding:20px;">?? ��� ��������� �������</p>
        <?php endif; ?>
        ...
        <div class="admin-card">
            <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
                ...
                <div style="display:flex;gap:6px;">
                    ...
                    <a href="?cancel=<?= $d['id'] ?>" class="btn btn-sm btn-red">? ������</a>
                </div>
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" style="display:flex;gap:4px;">
                            ...
                            <button type="submit" name="add_points" class="btn btn-sm btn-gold">+����</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>
