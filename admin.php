...
if (!isset($_SESSION['admin']) && (!isset($_POST['apass']) || $_POST['apass'] !== $password)) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') { $err = 'Неверный пароль администратора'; }
...
<header>
    <div class="header-inner">
        ...
        <nav class="nav">
            ...
            <a href="admin.php" class="btn btn-sm btn-red">👑 Админ</a>
        </nav>
    </div>
</header>
<div class="container animate-in">
    ...
    <div class="admin-stats">
        ...
        <div class="admin-stat green"><span class="num"><?= $completed_donations ?></span><span class="lbl">✅ Всего выдано</span></div>
        <div class="admin-stat blue"><span class="num"><?= $total_donations ?></span><span class="lbl">📦 Всего донатов</span></div>
    ...
    <div class="card" style="border-color:rgba(255,170,0,0.4);">
        ...
        <?php if ($pending_count === 0): ?>
            <p style="text-align:center;color:#888;padding:20px;">🎉 Нет ожидающих заказов</p>
        <?php endif; ?>
    ...
    <div class="card" style="margin-top:20px;">
        ...
        <div class="table-wrap">
            <table>
                <tr><th>ID</th><th>Логин</th><th>Ник</th><th>Баланс</th><th>Пополнить</th></tr>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" style="display:flex;gap:4px;">
                            ...
                            <button type="submit" name="add_points" class="btn btn-sm btn-gold">+Баллы</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>
    ...
    <div class="card" style="margin-top:20px;">
        <h2>📦 Все донаты (последние 30)</h2>
        <div class="table-wrap">
            <table>
                <tr><th>Пользователь</th><th>Ник</th><th>Товар</th><th>Статус</th><th>Дата</th></tr>
                ...
                <tr>
                    ...
                    <td class="status-<?= $d['status'] ?>">
                        <?= $d['status'] === 'pending' ? '🕒' : ($d['status'] === 'processing' ? '⚙' : ($d['status'] === 'completed' ? '✅' : '❌')) ?> <?= $d['status'] ?>
                    </td>
