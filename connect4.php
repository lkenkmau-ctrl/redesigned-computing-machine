...
?>
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Р§РµС‚С‹СЂРµ РІ СЂСЏРґ вЂ” DonateCraft</title><link rel="stylesheet" href="style.css"><style>
...
<h1>рџ”ґ Р§РµС‚С‹СЂРµ РІ СЂСЏРґ</h1>
...
<div class="game-status" id="statusDisplay">РўРІРѕР№ С…РѕРґ вЂ” РІС‹Р±РµСЂРё СЃС‚РѕР»Р±РµС†</div>
...
function initBoard() {
    ...
    score = 0;
    saved = false;
    statusDisplay.textContent = 'РўРІРѕР№ С…РѕРґ вЂ” РІС‹Р±РµСЂРё СЃС‚РѕР»Р±РµС†';
...
function dropPiece(col) {
    ...
    for (let r = ROWS - 1; r >= 0; r--) {
        if (board[col][r] === null) {
            ...
            statusDisplay.textContent = 'РҐРѕРґ РР...';
            draw();
...
function endGame(result) {
    gameOver = true;
    if (result === 'win') { score = 200; statusDisplay.textContent = 'рџЋ‰ РўС‹ РІС‹РёРіСЂР°Р»! +200 РѕС‡РєРѕРІ'; }
    else if (result === 'lose') { score = 0; statusDisplay.textContent = 'рџµ РР РїРѕР±РµРґРёР»!'; }
    else { score = 50; statusDisplay.textContent = 'рџ¤ќ РќРёС‡СЊСЏ! +50 РѕС‡РєРѕРІ'; }
