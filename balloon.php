...
?>
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Шарики — DonateCraft</title><link rel="stylesheet" href="style.css"><style>
...
<h1>🎈 Лопни шарик</h1>
<div class="game-info-bar"><div class="game-info-item"><span class="lbl">Счёт</span><span class="val" id="scoreDisplay">0</span></div><div class="game-info-item"><span class="lbl">Рекорд</span><span class="val" id="bestDisplay"><?= $bestScore ?></span></div><div class="game-info-item"><span class="lbl">⏱</span><span class="val" id="timerDisplay">30</span></div><div class="game-info-item"><span class="lbl">🎈 Вверху</span><span class="val" id="missedDisplay">0</span></div></div>
<div class="game-area">
<div>
<div class="legend">
<span class="legend-item"><span class="legend-dot" style="background:#ff3333"></span>Красный 10</span>
<span class="legend-item"><span class="legend-dot" style="background:#3388ff"></span>Синий 20</span>
<span class="legend-item"><span class="legend-dot" style="background:#ffd700"></span>Золотой 50</span>
</div>
...
function draw() {
  ...
  if (missed >= MAX_MISSED) {
    ...
    ctx.textAlign = 'center';
    ctx.fillText('💥 Слишком много улетело!', W/2, H/2);
  } else if (!gameActive) {
