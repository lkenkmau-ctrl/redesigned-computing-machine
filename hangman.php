...
?>
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Р’РёСЃРµР»РёС†Р° вЂ” DonateCraft</title><link rel="stylesheet" href="style.css"><style>
...
<div class="hint-row"><span id="hintLength">Р”Р»РёРЅР°: 0</span><span id="hintWrong">РћС€РёР±РѕРє: 0/6</span></div>
...
const WORDS = ['РїСЂРѕРіСЂР°РјРјРёСЂРѕРІР°РЅРёРµ','СЂР°Р·СЂР°Р±РѕС‚РєР°','РєРѕРјРїСЊСЋС‚РµСЂ','СЃРµСЂРІРµСЂ','Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ','РїРѕР»СЊР·РѕРІР°С‚РµР»СЊ','РёРЅС‚РµСЂС„РµР№СЃ','Р°Р»РіРѕСЂРёС‚Рј','С„СѓРЅРєС†РёСЏ','РїРµСЂРµРјРµРЅРЅР°СЏ','РєР»Р°СЃСЃ','РѕР±СЉРµРєС‚','РјР°СЃСЃРёРІ','СЃС‚СЂРѕРєР°','С‡РёСЃР»Рѕ','С†РёРєР»','СѓСЃР»РѕРІРёРµ','РѕРїРµСЂР°С‚РѕСЂ','РєРѕРјР°РЅРґР°','РїСЂРѕРµРєС‚','СЃРёСЃС‚РµРјР°','РїСЂРёР»РѕР¶РµРЅРёРµ','РјРѕРґСѓР»СЊ','РїР°РєРµС‚','Р±РёР±Р»РёРѕС‚РµРєР°','С„СЂРµР№РјРІРѕСЂРє','С€Р°Р±Р»РѕРЅ','СЃРѕР±С‹С‚РёРµ','РѕР±СЂР°Р±РѕС‚РєР°','Р·Р°РїСЂРѕСЃ','РѕС‚РІРµС‚','СЃРµСЃСЃРёСЏ','Р°РІС‚РѕСЂРёР·Р°С†РёСЏ','СЂРµРіРёСЃС‚СЂР°С†РёСЏ','РїР°СЂРѕР»СЊ','Р»РѕРіРёРЅ','РїРѕС‡С‚Р°','РјРѕРґРµСЂР°С‚РѕСЂ','СЂР°Р·СЂР°Р±РѕС‚С‡РёРє','С‚РµСЃС‚РёСЂРѕРІС‰РёРє','РґРѕРєСѓРјРµРЅС‚Р°С†РёСЏ','СЂРµРїРѕР·РёС‚РѕСЂРёР№','Р°РЅРёРјР°С†РёСЏ','РіСЂР°С„РёРєР°','РјРµС…Р°РЅРёР·Рј','РєРѕРЅСЃС‚СЂСѓРєС†РёСЏ','РЅР°РІРёРіР°С†РёСЏ','РєРѕР»Р»РµРєС†РёСЏ','РёС‚РµСЂР°С†РёСЏ','РєРѕРЅС‚РµР№РЅРµСЂ','РёРЅРґРµРєСЃР°С†РёСЏ'];
const MAX_WRONG = 6;
let word, guessed, wrongCount, gameOver, scoreSubmitted;

const ALPHABET = 'Р°Р±РІРіРґРµС‘Р¶Р·РёР№РєР»РјРЅРѕРїСЂСЃС‚СѓС„С…С†С‡С€С‰СЉС‹СЊСЌСЋСЏ'.split('');
...
function guessLetter(letter, btn) {
    ...
    if (word.includes(letter)) {
        ...
        wrongCount++;
        hintWrong.textContent = 'РћС€РёР±РѕРє: ' + wrongCount + '/6';
        drawHangman();
...
function endGame(won) {
    ...
    gameMessage.textContent = won ? 'рџЋ‰ РџРѕР±РµРґР°! Р’С‹ СѓРіР°РґР°Р»Рё СЃР»РѕРІРѕ: ' + word.toUpperCase() : 'рџ’Ђ Р’С‹ РїСЂРѕРёРіСЂР°Р»Рё. РЎР»РѕРІРѕ: ' + word.toUpperCase();
...
function resetGame() {
    ...
    hintLength.textContent = 'Р”Р»РёРЅР°: ' + word.length;
    hintWrong.textContent = 'РћС€РёР±РѕРє: 0/6';
    updateWordDisplay();
