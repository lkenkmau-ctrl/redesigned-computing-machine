...
?>
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Астероиды — DonateCraft</title><link rel="stylesheet" href="style.css"><style>
...
<h1>☄️ Астероиды</h1>
<div class="game-info-bar"><div class="game-info-item"><span class="lbl">Счёт</span><span class="val" id="scoreDisplay">0</span></div><div class="game-info-item"><span class="lbl">Рекорд</span><span class="val" id="bestDisplay"><?= $bestScore ?></span></div><div class="game-info-item"><span class="lbl">Волна</span><span class="val" id="waveDisplay">1</span></div></div>
<div class="game-area"><canvas id="gameCanvas" width="500" height="500"></canvas></div>
<div class="controls-hint">
<span class="key">W / ↑</span><span class="key">A / ←</span><span class="key">S / ↓</span><span class="key">D / →</span><span class="key">Пробел — огонь</span>
</div>
